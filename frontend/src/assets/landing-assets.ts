// Curated reliable high-resolution imagery and icons matching the referenced Artifix design

export const LANDING_IMAGES = {
  // Electrician card (technician in white hardhat working on electrical panel)
  electrician: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=600&q=80',
  
  // Babatunde O. portrait (Master Solar Technician)
  babatunde: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80',
  ...
  carpenter: 'https://images.unsplash.com/photo-1588854337221-4cf9fa96059c?auto=format&fit=crop&w=600&q=80',
  
  // Modern Architecture villa at dusk (warm interior lights)
  ...
  // Proof of Work: After (clean industrial power setup)
  proofAfter: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=400&q=80',
