  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        >
          <Bookmark className="w-4 h-4 text-emerald-600 fill-sky-500/20" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3.5 py-2 rounded-xl bg-slate-50 dark:bg-slate-900 text-xs focus:outline-none focus:ring-2 focus:ring-emerald-600 text-slate-900 dark:text-slate-100"
            />
          </div>
          ...
          <div className="relative">
            <select
              ...
              className="w-full px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-slate-900 text-xs focus:outline-none focus:ring-2 focus:ring-emerald-600 text-slate-900 dark:text-slate-100"
            >
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((n) => (
            <Card key={n} className="p-6 border-slate-200 animate-pulse space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {artisans.map((artisan) => {
            ...
            return (
              <Card
                key={artisan.id}
                className="p-5 flex flex-col justify-between hover:border-emerald-600/40 hover:shadow-lg transition-all border-slate-200 group"
              >
                <div>
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-1.5">
                          <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100 truncate group-hover:text-emerald-700 transition-colors">
                            {displayName}
                          </h3>
                ...
                <div className="pt-3 border-t border-slate-100 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <Link
                      ...
                      className="flex items-center justify-center gap-1 px-3 py-2 rounded-xl bg-sky-600 hover:bg-[#186644] text-white text-xs font-bold shadow-sm shadow-sky-600/20 transition-colors"
                    >
