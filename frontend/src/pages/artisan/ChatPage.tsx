...
export const ChatPage: React.FC = () => {
 ...
 >
 <div
 className={`max-w-sm sm:max-w-md p-3.5 rounded-[24px] text-xs space-y-1.5 shadow-xs ${
 isMe
 ? 'bg-[#186644] text-white rounded-br-xs'
 ...
 >
 <label
 className="p-2.5 rounded-xl text-slate-400 hover:text-emerald-600 hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer transition-colors"
