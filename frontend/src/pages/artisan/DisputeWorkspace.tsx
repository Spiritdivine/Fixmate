...
export const DisputeWorkspace: React.FC = () => {
 ...
 <div className="p-3.5 rounded-[24px] bg-slate-50 space-y-1">
 ...
 {dispute?.resolution && (
 <div className="p-4 rounded-[24px] bg-emerald-500/10 border border-emerald-500/30 space-y-2 text-xs">
 ...
 <div
 className={`max-w-md p-3.5 rounded-[24px] text-xs space-y-1 ${
 isAdmin
 ? 'bg-purple-950/40 border border-purple-800/60 text-purple-200'
 : isMe
 ? 'bg-emerald-600 text-white rounded-br-xs'
 : 'bg-slate-100 text-slate-900 dark:text-slate-100 rounded-bl-xs'
 }`}
 >
 ...
 <div className="space-y-2 p-3 rounded-xl bg-slate-50 ">
 <Input
 ...
 className="text-xs"
 />
 <label className="flex items-center justify-center gap-2 w-full p-2.5 rounded-xl border border-dashed border-slate-300 text-xs font-semibold text-emerald-600 hover:bg-emerald-50 dark:hover:bg-slate-800 cursor-pointer transition-colors">
 ...
 <div
 key={ev.id}
 className="p-2.5 rounded-xl bg-slate-50 flex items-center justify-between gap-2"
 >
 <a
 href={ev.fileUrl}
 target="_blank"
 rel="noopener noreferrer"
 className="flex items-center gap-2 min-w-0 hover:text-emerald-600 transition-colors"
 >
