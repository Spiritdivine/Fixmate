...
export const JobsMarketplace: React.FC = () => {
 ...
 <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-[#186644]/10 text-emerald-700 dark:text-emerald-400 border border-emerald-600/20 truncate">
 ...
 >
 {isSaved ? (
 <BookmarkCheck className="w-5 h-5 text-emerald-600 fill-emerald-500" />
 ) : (
 ...
 <h3 className="text-base font-bold text-slate-900 dark:text-slate-100 group-hover:text-emerald-600 transition-colors line-clamp-1">
 {job.title}
 </h3>
 </Link>
 ...
 <span
 key={s.skill.id}
 className="px-2 py-0.5 rounded-md text-[10px] font-medium bg-slate-100 text-slate-600 dark:text-slate-300"
 >
 {s.skill.name}
 </span>
 ))}
