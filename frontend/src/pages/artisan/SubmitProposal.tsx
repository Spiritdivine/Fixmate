...
export const SubmitProposal: React.FC = () => {
 ...
 {/* Header Banner */}
 <div className="p-6 rounded-3xl bg-emerald-900 border border-emerald-800 text-white space-y-2">
 ...
 {error && (
 <div className="p-4 rounded-[24px] bg-rose-500/10 border border-rose-500/30 text-rose-400 text-xs font-medium flex items-center gap-2">
 ...
 <div
 key={idx}
 className="p-4 rounded-[24px] bg-slate-50 space-y-3"
 >
 ...
 {/* Sum Validator Card */}
 <div
 className={`p-4 rounded-[24px] border text-xs font-semibold flex items-center justify-between ${
 isSumMatched
