...
export const JobDetails: React.FC = () => {
 ...
 <span className="px-3 py-1 rounded-full text-xs font-bold bg-[#186644]/10 text-emerald-700 dark:text-emerald-400 border border-emerald-600/20">
 {job.category?.name}
 </span>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-[24px] bg-slate-50 ">
 ...
 <span
 key={s.skill.id}
 className="px-3 py-1 rounded-xl text-xs font-medium bg-slate-100 text-slate-800 dark:text-slate-200 /80"
 >
 {s.skill.name}
 </span>
 ))}
 ...
 className="flex items-center justify-between p-3 rounded-xl bg-slate-50 hover:bg-emerald-50 dark:hover:bg-slate-750 transition-colors"
 >
