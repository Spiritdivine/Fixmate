...
export const ProposalsTracker: React.FC = () => {
 ...
 <p className="text-xs text-slate-700 dark:text-slate-300 line-clamp-3 bg-slate-50 p-3 rounded-xl ">
 ...
 <div
 key={m.id}
 className="p-2.5 rounded-xl bg-slate-50 text-xs flex items-center justify-between"
 >
