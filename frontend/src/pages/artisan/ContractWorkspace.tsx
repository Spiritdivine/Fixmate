...
export const ContractWorkspace: React.FC = () => {
 ...
 <div className="text-left sm:text-right shrink-0 bg-slate-50 p-4 rounded-[24px] ">
 ...
 {isRevision && (
 <div className="p-3.5 rounded-[24px] bg-amber-500/10 border border-amber-500/30 text-amber-500 text-xs font-medium space-y-1">
 ...
 <div className="p-3 rounded-xl bg-slate-100 text-xs font-semibold flex items-center justify-between">
 ...
 className="text-xs text-slate-400 file:mr-3 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-emerald-600 file:text-white hover:file:bg-emerald-700"
 />
