...
export const ReviewsPage: React.FC = () => {
 ...
 <span className="text-xs text-emerald-600 font-semibold">Responsive & Clear</span>
 </Card>
 ...
 {r.artisanReply && (
 <div className="ml-12 p-3 rounded-[24px] bg-emerald-50/60 dark:bg-emerald-950/20 border border-emerald-600/20 space-y-1">
